...
Agentic Log Investigator is an LLM-powered agent that:

Retrieves the right operational context

Reasons using tools, memory, and structured prompts

Produces grounded root-cause hypotheses

Provides actionable next steps

Enforces evaluation, observability, and cost control
